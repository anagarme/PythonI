...
def juego(rondas):
    ...
    Returns:
    Por cada opción que el jugador elija se imprime el resultado (ganar o perder).
    """
...
print(f'Las reglas son sencillas, {nombre}, sólo debes introducir el número de partidas y tu opción (papel, piedra, tijera).')
...
while jugar: 
    ...
    # Para que el usuario decida si continúa el juego o termina 
    jugar = int(input('Ingresa 1 si deseas volver a jugar o 0 para cerrarlo: '))

print('Gracias por jugar conmigo, espero que te hayas divertido :)')
